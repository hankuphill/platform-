...
namespace Platform
{
	...
	public class Field
	{
		...
		public void display()
		{
			...
			for (int row = 0; row < ROW; ++row)
			{
				...
				for (int col = 0; col < COL; ++col)
				{
					...
					{
						Console.Clear();
						Console.WriteLine("Unindentified num!");
						Console.Read();
			...
			Console.WriteLine();
				Console.WriteLine("BasePoint: {0}", BasePoint);
		...
		public void movePlatform(int LeftRight)
		{
			...
			//if (BasePoint+3>COL) BasePoint=COL-3;
